...
con = sqlite3.connect("Recommend.db")#"localhost","root","lnm@#$"
cur = con.cursor()
...
table = sql.read_frame('select age,gender,profession,genre_name,author,preference from Books b,Users u,UserBooks ub where ub.user_id=u.user_id and ub.book_id=b.book_id;', con)
